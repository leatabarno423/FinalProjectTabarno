...
<head>
  ...
  <title>Lea Castillo Tabarno</title>
  ...
  <style>
    ...
    .about { background-color: #7b3e3e; }
    .skills { background-color: #e6b8a2; color: #000; text-align: center; }
    .resume { background-color: #2c2f45; text-align: center;}
    .contact { background-color: #662929; text-align: center;}
    .footer {
      text-align: center;
      padding: 10px;
      font-size: 0.9rem;
